const Footer = () => {
  return (
    <footer id="contact" className="py-16 px-4 sm:px-6 lg:px-8 border-t border-[hsl(var(--tokyo-border))]">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-2">
            ...
            <p className="text-[hsl(var(--tokyo-text))] mb-4 max-w-md">
        ...
        <div className="border-t border-[hsl(var(--tokyo-border))] mt-8 pt-8 text-center text-gray-400">
