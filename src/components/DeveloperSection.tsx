...
console.log(response.choices[0].message.content);`;
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[hsl(var(--tokyo-card))]">
      <div className="max-w-7xl mx-auto flex sm:flex-row flex-col items-center justify-between">
        <div className="text-left mb-16 md:w-1/2 w-full">
          ...
          <p className="text-xl text-[hsl(var(--tokyo-text))] max-w-2xl mx-auto">
            Make your first API request in minutes. <br />
        ...
        <div className="md:w-1/2 w-full mx-auto">
          ...
          <div className="tokyo-card rounded-xl p-6">
            ...
            <div className="bg-black rounded-lg p-4 font-mono text-sm overflow-x-auto">
              <pre className="whitespace-pre-wrap">
                <code className="text-[hsl(var(--tokyo-text))]">
                  {codeExample}
                </code>
              </pre>
            </div>
